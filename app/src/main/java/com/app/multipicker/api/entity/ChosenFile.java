package com.app.multipicker.api.entity;
...
public class ChosenFile implements Parcelable {
    ...
    private boolean isOnlineFile; //For Local Use -> When edit Announcement
    private String fileUrl; //For Local Use -> When edit Announcement
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeLong(createdAt == null ? new Date().getTime() : createdAt.getTime());
    ...
    /**
     * Display name of the file with out extension if have
     *
     * @return
     */
    public String getDisplayNameWithOutExtension() {

        String nameWithoutExtension = displayName;

        if (nameWithoutExtension != null && !nameWithoutExtension.isEmpty()) {
            if (nameWithoutExtension.lastIndexOf(".") != -1 && nameWithoutExtension.lastIndexOf(".") != 0)
    ...
    /**
     * Get the specific extension only (doc, docx, xls, pdf)
     *
     * @return
     */
    public String getSpecificFileTypeExtension() {
        String extension = "";
        if (mimeType != null && !mimeType.isEmpty()) {
            ...
            switch (contentType.toLowerCase()) {
                ...
                default:
                    ...
                    //Try to fetch the extension from file name
                    String fileDisplayName = getDisplayName();
                    if (fileDisplayName != null && !fileDisplayName.isEmpty()) {
                        if (fileDisplayName.lastIndexOf(".") != -1 && fileDisplayName.lastIndexOf(".") != 0)
                            extension = "." + fileDisplayName.substring(fileDisplayName.lastIndexOf(".") + 1);
                    }
    ...
    public String getSpecificFileTypeExtensionWithoutDot(){
        String fileExtension = getSpecificFileTypeExtension();
    ...
    public void setOnlineFile(boolean onlineFile) {
        isOnlineFile = onlineFile;
    }
